...
- [ ] 🔴 **Ghi nhận thời gian gọi** — Tự động lưu timestamp khi tạo order cho các orderItem
...
- [ ] 🔴 **Xem chi tiết order của bàn** — Danh sách món + số lượng + giá + ghi chú + món nào đã ra món nào chưa ra

### 1.5 Quản lý bếp

- [ ] 🔴 **Hiển thị danh sách món ăn, sắp xếp theo thời gian** — Hiển thị danh sách món ăn cần thực hiện cho bếp, sắp xếp theo thời gian đặt món
- [ ] 🔴 **Hiển thị thời gian chờ** — "Món chân gà bàn 3: Đã gọi 15p trước"
- [ ] 🔴 **Hiển thị tổng các món cần làm** — Hiển thị tổng các món cần làm cho tất cả các bàn hiện tại
- [ ] 🔴 **Đánh dấu đã phục vụ** — Cập nhật trạng thái từng món ăn đã mang ra cho khách
